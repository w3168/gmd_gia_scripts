...
long_burgers = "long/"
incomp = np.loadtxt(f"{long_burgers}displacement-weerdesteijn-3d-internalvariable-symmult_nondim-refinedsurfaceTrue-dx5.0km-nz10perlayer-dt1000.0years-bulk100.0-nondim.dat")
...
ax[1].plot(incomp[:,0]/1e3, incomp[:,1], color=colour_incomp, linewidth=lw, linestyle='-', label=r'Incompressible')
ax[1].plot(gadopt_displacement_comp_burgers[:,0]/1e3, gadopt_displacement_comp_burgers[:,1], color=colour_comp, linewidth=lw, linestyle='-', label=r'Compressible')
ax[1].plot(gadopt_displacement_comp_burgers_0pt5[:,0]/1e3, gadopt_displacement_comp_burgers_0pt5[:,1], color=colour_burgers_2, linewidth=lw, linestyle='-', label=r'Burgers ($\eta_1 / \eta_2 = 2$)')
ax[1].plot(gadopt_displacement_comp_burgers_0pt1[:,0]/1e3, gadopt_displacement_comp_burgers_0pt1[:,1], color=colour_burgers_10, linewidth=lw, linestyle='-', label=r'Burgers ($\eta_1 / \eta_2 = 10$)')
...
ax[1].legend(loc='lower left', fontsize=fs, framealpha=1, facecolor='white', edgecolor='black', fancybox=False).get_frame().set_linewidth(lw)
ax[1].annotate(
        "b",
...
figname = "Figure_6_compressible_burgers_22.05.25"
