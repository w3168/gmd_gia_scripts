...
ms = 0.75
lw = 0.75
ax[0].plot(theta_1d, ice_1d, color='r', linestyle='-', linewidth=lw+0.5,alpha=0.4,  label='Axisym.')
ax[0].plot(theta_3d, ice_3d, color='b', linestyle='-', linewidth=lw+0.5,alpha=0.4, label='LVV')
...
ax[1].semilogy(obj_1d[:50], color='r', linestyle='-', alpha=0.4, linewidth=lw, label='Axisym.')
ax[1].semilogy(obj_3d, color='b', linestyle='-', alpha=0.4, linewidth=lw, label='LVV')
...
figname = "Figure_9_ice_inversion_21.08.25"
