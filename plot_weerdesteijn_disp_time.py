...
folder_gadopt_burgers = "./weerdesteijn_data/internal_variable/nondimensional/burgers/"
...
# Plot compressible vs incompressible 
...
gadopt_displacement_bulk1pt94_compbuoy = np.loadtxt(f"{folder_gadopt}displacement-weerdesteijn-3d-internalvariable-symmult_nondim_gmres_Vifix-refinedsurfaceTrue-dx5.0km-nz10perlayer-dt1000.0years-bulk1.94-compbuoyTrue-nondim.dat")
...
ax.plot(gadopt_displacement_bulk1pt94_compbuoy[:,0], gadopt_displacement_bulk1pt94_compbuoy[:,1], 'k-', label='G-ADOPT, compressible (incl. buoyancy) 1.94')
...
figname = "31.03.25_gadopt_3d_weerdesteijn_internalvariable_nondim_dx5_nz10_dt1ka_bulkcomparison"
fig.savefig(f'{figname}.png')
#plt.show()
ax.set_xlim([70e3, 110e3])
ax.set_ylim([-80, -45])
...
'''
# Check two internal variables matches 
gadopt_displacement_bulk2x = np.loadtxt(f"{folder_gadopt}displacement-weerdesteijn-3d-internalvariable-symmult_nondim-refinedsurfaceTrue-dx5.0km-nz10perlayer-dt1000.0years-bulk2.0-nondim.dat")
