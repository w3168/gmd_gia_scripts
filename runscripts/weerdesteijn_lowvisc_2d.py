...
class LowViscosityWeerdesteijn2d(Weerdesteijn2d):
    name = "weerdesteijn-low-viscosity-2d-squashed"
    vertical_component = 1

    def __init__(self, **kwargs):
        super().__init__(low_viscosity_region=True, **kwargs)
...
if __name__ == "__main__":
    simulation = LowViscosityWeerdesteijn2d(dx=5e3, nz=160, Tend_years=5000, do_write=True)
