...
def generate_mesh():
    ...
    p2 = gmsh.model.geo.addPoint(Rg, 0, 0, lc, 2)
    p3 = gmsh.model.geo.addPoint(0, Rg, 0, lc, 3)
    p4 = gmsh.model.geo.addPoint(-Rg, 0, 0, lc, 4)
    p5 = gmsh.model.geo.addPoint(0, -Rg, 0, lc, 5)
    p6 = gmsh.model.geo.addPoint(Re, 0, 0, lc, 6)
    p7 = gmsh.model.geo.addPoint(0, Re, 0, lc, 7)
    p8 = gmsh.model.geo.addPoint(-Re, 0, 0, lc, 8)
    p9 = gmsh.model.geo.addPoint(0, -Re, 0, lc, 9)
    p10 = gmsh.model.geo.addPoint(Rc, 0, 0, lc, 10)
    p11 = gmsh.model.geo.addPoint(0, Rc, 0, lc, 11)
    p12 = gmsh.model.geo.addPoint(-Rc, 0, 0, lc, 12)
    p13 = gmsh.model.geo.addPoint(0, -Rc, 0, lc, 13)
    #
