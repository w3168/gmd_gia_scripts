...
rho1_grav.interpolate(dot(z.subfunctions[0], grad(density))+density*div(z.subfunctions[0]),subset=full_mesh.topology.cell_subset(999))
...
if OUTPUT:
    ...
    grav_output_file.write(rho1_grav, grav_solution)
