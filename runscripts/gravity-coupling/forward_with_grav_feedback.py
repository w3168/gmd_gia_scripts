...
name = f"submesh-withurfDG-2d-internalvariable-dispvel-{args.optional_name}-1dvisc{args.radial_visc}"
...
ice_load_func = Function(DG1, name="iceload").interpolate(rho_ice * (Hice1 * disc1 + Hice2 * disc2))
